...
class LQ4DirectionsScrollView: UIView, UITableViewDelegate, UITableViewDataSource {
    ...
    typealias LQ4DirectionsScrollViewHandle = (_ model: LQ4Model) -> Void
    
    var dataSource: [[LQ4Model]] = []
    ...
    ///   - didSelected: 选择回调
    ///   - didScrolled: 滚动回调
    init(withDatas datas: [[LQ4Model]], frame: CGRect, didSelected: LQ4DirectionsScrollViewHandle?, didScrolled: LQ4DirectionsScrollViewHandle?) {
    ...
    private func setupMainView() {
        ...
        table.register(LQ4DirectionTableViewCell.self, forCellReuseIdentifier: "LQ4DirectionTableViewCellReuseIdentifier")
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "LQ4DirectionTableViewCellReuseIdentifier", for: indexPath) as! LQ4DirectionTableViewCell
